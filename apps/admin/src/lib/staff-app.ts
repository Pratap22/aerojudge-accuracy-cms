...
/**
 * Send Judge-primary users to the scoring terminal (and ops-only users to Admin).
...
export function openStaffApp(target: StaffAppId): void {
  ...
  // Same-origin still needs intent for this tab; cross-origin gets it via handoff hash.
