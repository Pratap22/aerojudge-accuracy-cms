...
DEPLOY_DIR="${DEPLOY_DIR:-/home/ubuntu/apps/aerojudge-accuracy-cms}"
...
echo "Note: this host may run other apps — prefer docker compose stop for AeroJudge, not EC2 stop."
